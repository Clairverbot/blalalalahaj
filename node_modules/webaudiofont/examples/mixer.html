...
<body>		
	...
	<ul>
		...
		<li>compressor threshold <input type="range" value="-50" min="-60" max="-1" step="1" onchange="reverberator.output.threshold.setValueAtTime(value, 0);"></li>
		<li>compressor knee <input type="range" value="40" min="0" max="40" step="2" onchange="reverberator.output.knee.setValueAtTime(value, 0)"></li>
		<li>compressor ratio <input type="range" value="12" min="1" max="20" step="1" onchange="reverberator.output.ratio.setValueAtTime(value, 0);"></li>
		<li>compressor attack <input type="range" value="0" min="0" max="1" step="0.01" onchange="reverberator.output.attack.setValueAtTime(value, 0);"></li>
		<li>compressor release <input type="range" value="0.25" min="0" max="1" step="0.01" onchange="reverberator.output.release.setValueAtTime(value, 0);"></li>
	</ul>
